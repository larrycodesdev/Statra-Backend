...
class CheckInSpec
{
    ...
    /**
     * @OA\Post(path="/api/v1/checkin/auth/login", tags={"Auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/checkin/auth/logout", tags={"Auth"},
     *   summary="Revoke current token", security={{"bearerAuth":{}}},
     ...
     *       description="'None' or a red-flag symptom name — immediately overrides status to Urgent"),
     ...
     *       description="Any red-flag value triggers immediate Urgent override (score=OVERRIDE)",
     ...
     *     )
     *   )),
     *   @OA\Response(response=200, description="Check-in result",
     *     @OA\JsonContent(
     *       @OA\Property(property="id",           type="integer", example=1),
     *       @OA\Property(property="pid",          type="string",  example="SCD-001"),
     *       @OA\Property(property="total",        type="integer", example=11, description="999 means OVERRIDE (red flag)"),
     *       @OA\Property(property="displayScore", type="string",  example="11", description="'OVERRIDE' or stringified total"),
     *       @OA\Property(property="status",       type="string",  enum={"Stable","Watch closely","Elevated","Urgent"}, example="Elevated"),
     ...
     *         description="Genotype multiplier — SS/SB0=1.2, SB+=1.1, others=1.0"),
     ...
     *   summary="Most recent check-in result for the logged-in user",
     *   security={{"bearerAuth":{}}},
