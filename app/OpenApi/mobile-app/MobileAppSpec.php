...
class MobileAppSpec
{
    ...
    /**
     * @OA\Post(path="/api/v1/patient/auth/register", tags={"Patient Auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/patient/auth/login", tags={"Patient Auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/patient/auth/social", tags={"Patient Auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/patient/auth/forgot-password", tags={"Patient Auth"},
     *   summary="Step 1 — Request 6-digit OTP via email",
     *   @OA\RequestBody(required=true, @OA\JsonContent(
     *     required={"email"},
     *     @OA\Property(property="email", type="string", format="email", example="jane@example.com")
     *   )),
    ...
    /**
     * @OA\Post(path="/api/v1/patient/auth/verify-otp", tags={"Patient Auth"},
     *   summary="Step 2 — Verify OTP, receive reset_token",
     *   @OA\RequestBody(required=true, @OA\JsonContent(
     *     required={"email","otp"},
     ...
     *       @OA\Property(property="data", type="object",
     *         @OA\Property(property="reset_token", type="string", example="AbCdEf...")
     *       )
     *     )
     *   ),
    ...
    /**
     * @OA\Post(path="/api/v1/patient/auth/reset-password", tags={"Patient Auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/patient/auth/logout", tags={"Patient Auth"},
     *   summary="Revoke current device token", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Put(path="/api/v1/patient/auth/change-password", tags={"Patient Auth"},
     *   summary="Change password while logged in (Settings screen)", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Get(path="/api/v1/patient/profile", tags={"Patient Profile"},
     *   summary="Get full patient profile", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Put(path="/api/v1/patient/profile", tags={"Patient Profile"},
     *   summary="Update personal info", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Put(path="/api/v1/patient/profile/medical-info", tags={"Patient Profile"},
     *   summary="Update genotype, blood type, conditions", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Put(path="/api/v1/patient/profile/emergency-contacts", tags={"Patient Profile"},
     *   summary="Update emergency contact", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
     *     required={"name","phone"},
    ...
    /**
     * @OA\Put(path="/api/v1/patient/profile/fcm-token", tags={"Patient Profile"},
     *   summary="Refresh FCM push token — call on every app launch", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
     *     required={"fcm_token"},
    ...
    /**
     * @OA\Get(path="/api/v1/patient/settings", tags={"Patient Settings"},
     *   summary="Get privacy and notification settings", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Put(path="/api/v1/patient/settings", tags={"Patient Settings"},
     *   summary="Update privacy/notification toggles", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Post(path="/api/v1/patient/device/register", tags={"Patient Device"},
     *   summary="Register or update the connected JCVital wearable", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Get(path="/api/v1/patient/device/status", tags={"Patient Device"},
     *   summary="Get all registered devices and their last-sync status", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Post(path="/api/v1/patient/vitals/sync", tags={"Patient Vitals"},
     *   summary="Sync a batch of readings — 202 returned immediately, processed async", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Get(path="/api/v1/patient/vitals", tags={"Patient Vitals"},
     *   summary="Get vitals history", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/patient/alerts", tags={"Patient Alerts"},
     *   summary="Get alerts triggered for this patient", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Post(path="/api/v1/patient/pain-log", tags={"Patient Logs"},
     *   summary="Log a pain episode", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Get(path="/api/v1/patient/pain-log", tags={"Patient Logs"},
     *   summary="Get pain log history", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Post(path="/api/v1/patient/medication-log", tags={"Patient Logs"},
     *   summary="Log a medication entry", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Get(path="/api/v1/patient/medication-log", tags={"Patient Logs"},
     *   summary="Get medication log history", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/patient/appointments", tags={"Patient Logs"},
     *   summary="Get upcoming and past appointments", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Post(path="/api/v1/doctor/auth/register", tags={"Doctor Auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/doctor/auth/login", tags={"Doctor Auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/doctor/auth/logout", tags={"Doctor Auth"},
     *   summary="Revoke doctor token", security={{"bearerAuth":{}}},
     *   @OA\Response(response=200, description="Logged out", @OA\JsonContent(ref="#/components/schemas/SuccessResponse"))
     * )
     */
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/patients", tags={"Doctor Patients"},
     *   summary="List all assigned patients", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/patients/{id}", tags={"Doctor Patients"},
     *   summary="Get full patient detail", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/patients/{id}/vitals", tags={"Doctor Patients"},
     *   summary="Get a patient's vitals", security={{"bearerAuth":{}}},
     *   @OA\Parameter(name="id",    in="path",  required=true, @OA\Schema(type="integer")),
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/patients/{id}/alerts", tags={"Doctor Patients"},
     *   summary="Get alerts for a patient", security={{"bearerAuth":{}}},
     *   @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
    ...
    /**
     * @OA\Post(path="/api/v1/doctor/patients/{id}/notes", tags={"Doctor Patients"},
     *   summary="Add a clinical note", security={{"bearerAuth":{}}},
     *   @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/dashboard", tags={"Doctor Patients"},
     *   summary="Summary metrics — total patients, active alerts, upcoming appointments", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/alerts", tags={"Doctor Alerts"},
     *   summary="Get all patient alerts", security={{"bearerAuth":{}}},
     *   @OA\Parameter(name="status", in="query", @OA\Schema(type="string", enum={"pending","acknowledged","resolved"})),
    ...
    /**
     * @OA\Put(path="/api/v1/doctor/alerts/{id}/resolve", tags={"Doctor Alerts"},
     *   summary="Mark alert as resolved", security={{"bearerAuth":{}}},
     *   @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
    ...
    /**
     * @OA\Put(path="/api/v1/doctor/alerts/{id}/assign", tags={"Doctor Alerts"},
     *   summary="Assign alert to a doctor", security={{"bearerAuth":{}}},
     *   @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
     *   @OA\RequestBody(required=true, @OA\JsonContent(
     *     required={"doctor_id"},
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/appointments", tags={"Doctor Appointments"},
     *   summary="Get doctor's appointments", security={{"bearerAuth":{}}},
     *   @OA\Response(response=200, description="Appointments", @OA\JsonContent(ref="#/components/schemas/PaginatedResponse"))
     * )
     */
    ...
    /**
     * @OA\Post(path="/api/v1/doctor/appointments", tags={"Doctor Appointments"},
     *   summary="Schedule a new appointment", security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Put(path="/api/v1/doctor/appointments/{id}", tags={"Doctor Appointments"},
     *   summary="Update appointment", security={{"bearerAuth":{}}},
     *   @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
     *   @OA\RequestBody(required=true, @OA\JsonContent(
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/reports/health-trends", tags={"Doctor Reports"},
     *   summary="Vitals trends across assigned patients", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/reports/alerts-analytics", tags={"Doctor Reports"},
     *   summary="Alert counts by type, level, status", security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/doctor/reports/export", tags={"Doctor Reports"},
     *   summary="Export vitals as CSV", security={{"bearerAuth":{}}},
