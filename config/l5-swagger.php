...
return [
    ...
    'documentations' => [
        ...
        // ── Doctor Dashboard docs (/docs/doctor-dashboard) ──────────────────
        'doctor-dashboard' => [
            'api' => [
            ...
            'generate_always' => false,
            'routes' => [
                'api'             => 'api/v1/docs/doctor-dashboard.json',
                'docs'            => 'docs/doctor-dashboard',
                'oauth2_callback' => 'api/oauth2-callback',
                'middleware'      => ['api' => [], 'asset' => [], 'docs' => [], 'oauth2_callback' => []],
                'group_options'   => [],
            ],
            'paths' => [
                'docs'                   => public_path('api-docs/doctor-dashboard'),
                'docs_json'              => 'doctor-dashboard-api-docs.json',
                'docs_yaml'              => 'doctor-dashboard-api-docs.yaml',
                'annotations'            => [base_path('app/OpenApi/DoctorDashboard')],
                'views'                  => base_path('resources/views/vendor/l5-swagger'),
                'base'                   => null,
                'swagger_ui_assets_path' => 'docs/doctor-dashboard/asset/',
                'excludes'               => [],
            ],
            'ui' => [
                'display' => [
