...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($driver === 'sqlsrv') {
            ...
            // SQLite / MySQL — add the column; MySQL gets the check, SQLite skips it
            DB::statement("ALTER TABLE patients ADD COLUMN age_group VARCHAR(20) NULL");
            if ($driver === 'mysql') {
                DB::statement("ALTER TABLE patients ADD CONSTRAINT patients_age_group_check
                    CHECK (age_group IN ('infant','child','adolescent','adult'))");
            }
        }
    }
